...
var Sortable = require('src/assets/js/sortable.js');

@Component({
  selector: 'app-form-fluid',
  templateUrl: './form-fluid.component.html',
  styleUrls: ['./form-fluid.component.css']
})
export class FormFluidComponent implements OnInit {
  ...
  ngAfterViewInit() {
    const dragItems: any = document.querySelector('#formFluid');
